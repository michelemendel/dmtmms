...
func (vctx *ViewCtx) UserUpdateForm(selectedUser entity.User) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/users.templ`, Line: 64, Col: 28}
		}
...
func (vctx *ViewCtx) roleOptions(selectedUser entity.User) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for _, role := range vctx.Roles {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/users.templ`, Line: 82, Col: 72}
			}
...
func (vctx *ViewCtx) UserList(users []entity.User) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for _, user := range users {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/users.templ`, Line: 95, Col: 16}
			}
			...
			if user.Name != ctx.Value(constants.CTX_USER_NAME_KEY).(string) {
				...
				if vctx.TempPassword != "" && vctx.TempPasswordUserName == user.Name {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `view/users.templ`, Line: 128, Col: 55}
					}
